...
export default function Footer() {
  ...
  // Bug report URL with pre-filled template
  const bugReportUrl = 'https://github.com/RocketMobster/warpcorereports/issues/new?' + new URLSearchParams({
    title: '[Bug] ',
    labels: 'bug',
